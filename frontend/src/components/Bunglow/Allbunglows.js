        ...
        <div className=" mx-32 mt-14">
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 400 }} aria-label="customized table">
              <TableHead>
                <TableRow>
                  <StyledTableCell>Bunglow Reference No</StyledTableCell>
                  <StyledTableCell align="right">Bunglow Place</StyledTableCell>
                  <StyledTableCell align="right">Bunglow Price</StyledTableCell>
